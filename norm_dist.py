...
fig.add_trace(go.Scatter(x=[range1s, range1s], y=[0, 0.06], mode="lines", name="STANDARD DEVIATION 1"))
fig.add_trace(go.Scatter(x=[range1e, range1e], y=[0, 0.06], mode="lines", name="STANDARD DEVIATION 1"))
fig.add_trace(go.Scatter(x=[range2s, range2s], y=[0, 0.06], mode="lines", name="STANDARD DEVIATION 2"))
fig.add_trace(go.Scatter(x=[range2e, range2e], y=[0, 0.06], mode="lines", name="STANDARD DEVIATION 2"))
fig.show()